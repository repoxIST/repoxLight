...
//    }
    ...
    public void setNextIngest(String nextIngest) {
        set("nextIngest", nextIngest);
    }
...
//    public Integer getIntRecords(){return (Integer) get("recordsInt");}
    ...
    public void setTotalRecordsStr(String totalRecordsStr) {
        set("totalRecordsStr", totalRecordsStr);
    }
    ...
    public void setIngestPercentage(float percentage) {
    ...
    public void setIngestTimeLeft(long timeLeft) {
        set("timeLeft", timeLeft);
    }

    public long getIngestTimeLeft() {
        return (Long) get("timeLeft");
    }
...
//    public Long getAverageIngestTime() {return (Long) get("averageIngestTime");}
    ...
    public void setURLSourcesPath(String urlSourcesPath) {
        set("urlSourcesPath", urlSourcesPath);
    }
    ...
    public void setExternalServicesRunType(String externalServicesRunType) {
        set("externalServicesRunType", externalServicesRunType);
    }
    ...
    public void setMetadataFormat(String mtdFormat) {
        set("metadataFormat", mtdFormat);
    }
    ...
    public void setSourceMDFormat(String sourceMDFormat) {
        set("sourceMDFormat", sourceMDFormat);
    }
    ...
    public void setHasRunningTask(boolean hasRunningTask) {
        set("hasRunningTask", hasRunningTask);
    }

    public boolean getHasRunningTask() {
        return (Boolean) get("hasRunningTask");
    }

    public void setDataSourceSet(String dsSet) {
        set("dataSourceSet", dsSet);
    }
    ...
    public void setIsoVariant(String isoVariant) {
        set("isoVariant", isoVariant);
    }
    ...
    public void setCharacterEncoding(String characterEncoding) {
        set("characterEncoding", characterEncoding);
    }
    ...
    public void setRecordIdPolicy(String recordIdPolicy) {
        set("recordIdPolicy", recordIdPolicy);
    }
    ...
    public void setMetadataTransformations(List<TransformationUI> transformations) {
        metadataTransformations = transformations;
    }
    ...
    public void setMetadataNamespace(String metadataNamespace) {
        set("metadataNamespace", metadataNamespace);
    }
    ...
    public void setRecordsPerFile(String recordsPerFile) {
        set("recordsPerFile", recordsPerFile);
    }
    ...
    */
    public void setRetrieveStartegy(String strategy) {
        set("retrieveStrategy", strategy);
    }
    ...
    public void setNamespaceList(List<String> namespaces) {
        namespaceList = namespaces;
    }

    public void setOaiSource(String src) {
        set("oaiSource", src);
    }
    ...
    public void setFileExtract(String fileExtract) {
        set("fileExtract", fileExtract);
    }
    ...
    public void setRecordRootName(String rootName) {
        set("recordRootName", rootName);
    }
     ...
     */
    public void setZ39Address(String z39Address) {
        set("z39Address", z39Address);
    }
    ...
    public void setZ39Port(String port) {
        set("z39Port", port);
    }
    ...
    public void setZ39Database(String database) {
        set("z39Database", database);
    }
    ...
    public void setZ39User(String user) {
        set("z39User", user);
    }
    ...
    public void setZ39Password(String password) {
        set("z39Password", password);
    }
    ...
    public void setZ39RecordSyntax(String recordSyntax) {
        set("z39RecordSyntax", recordSyntax);
    }
    ...
    public void setZ39HarvestMethod(String harvestMethod) {
        set("z39HarvestMethod", harvestMethod);
    }
    ...
    public void setZ39MaximumId(String maximumId) {
        set("z39MaximumId", maximumId);
    }
    ...
    public void setZ39IdListFile(String idListFile) {
        set("z39IdListFile", idListFile);
    }
