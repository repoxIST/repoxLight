...
public class TransformationUI extends BaseModel implements IsSerializable {
    ...
    public void setDestSchema(String schema) {
        set("destSchema", schema);
    }

    public String getDestSchema() {
        return (String) get("destSchema");
    }

    public void setMetadataNamespace(String destMtdNamespace) {
        set("destMtdNamespace", destMtdNamespace);
    }

    public String getDestMetadataNamespace() {
        return (String) get("destMtdNamespace");
    }

    public void setIsXslVersion2(boolean isXslVersion2) {
        set("isXslVersion2", isXslVersion2);
    }

    public boolean getIsXslVersion2() {
        return (Boolean) get("isXslVersion2");
    }

    public void setXslFilePath(int xslFilePath) {
        set("xslFilePath", xslFilePath);
    }
    ...
    public String getSourceSchema() {
        return (String) get("sourceSchema");
    }

    public void setMDRCompliant(boolean compliant) {
        set("bMDRCompliant", compliant);
    }

    public Boolean isMDRCompliant() {
        return (Boolean) get("bMDRCompliant");
    }

    public void setEditable(boolean editable) {
        set("bEditable", editable);
    }

    public Boolean isEditable() {
        return (Boolean) get("bEditable");
    }
    ...
    public void setDSStringFormat(String text) {
        set("dsStringFormat", text);
    }
