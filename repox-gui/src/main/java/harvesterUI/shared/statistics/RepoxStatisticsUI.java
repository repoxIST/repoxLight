...
public class RepoxStatisticsUI extends BaseModel implements IsSerializable {
    ...
    public Integer getDataSourcesTotal() {
        return (Integer) get("dataSourcesTotal");
    }
    ...
    public Map<String, Integer> getDataSourcesMetadataFormats() {
        return (Map<String, Integer>) get("dataSourcesMetadataFormats");
    }

    public Map<String, Integer> getRecordsMetadataFormats() {
        return (Map<String, Integer>) get("recordsMetadataFormats");
    }
    ...
    public Map<String, Integer> getCountriesRecords() {
        return (Map<String, Integer>) get("countriesRecords");
    }
