...
public class RestServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            } else if (webServices instanceof WebServicesImpl) {
                if (restRequest.getUriHierarchy().get(1).equals("createZ3950IdList")) {
                    ...
                    if (dataProviderId != null && !dataProviderId.isEmpty() &&
                        ...
                        webServices.createDataSourceZ3950IdList(out, dataProviderId, id, description, schema,
                                ...
                                xsdFile, recordIdPolicy, idXpath, namespacePrefix, namespaceUri);
                    } else {
                        webServices.createErrorMessage(out, MessageType.INVALID_REQUEST, "Error creating the Data" +
                                ...
                                "are mandatory)]" + " NOTE: ID FILE MUST BE UPLOADED THROUGH HTTP POST");
                    }
                    ...
                    if (id != null && !id.isEmpty()) {
                        webServices.updateDataSourceZ3950IdList(out, id, description, schema, namespace, address,
                                port, database, user, password, recordSyntax, charset, xsdFile, recordIdPolicy,
