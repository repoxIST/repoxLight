...
//                Date creationDate = new Date(currentElement.elementText("creationDate").replace("BST","GMT"));
                ...
                MetadataSchema metadataSchema = new MetadataSchema(designation, shortDesignation, description,
                        namespace, notes, metadataSchemaVersions);
    ...
    public MessageType saveMetadataSchema(String designation, String shortDesignation, String description,
                                          String namespace, String notes, String oldId,
...
//        }
    ...
    public MessageType updateMetadataSchema(String designation, String shortDesignation, String description,
                                            String namespace, String notes, String oldId,
                                            List<MetadataSchemaVersion> metadataSchemaVersions, boolean bOAIAvailable) {
        if (oldId != null && oldId.equals(shortDesignation)) {
            // Do nothing
