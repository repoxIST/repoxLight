...
/**
 * Contains a definition and an implementation of a particular access point in a DataSource
 * This class is responsible for extracting the values to be indexed from a record
 *
 * @author Nuno Freire
 */
