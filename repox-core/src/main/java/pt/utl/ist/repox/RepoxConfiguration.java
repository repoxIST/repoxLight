...
public abstract class RepoxConfiguration {
    ...
    public RepoxConfiguration(Properties configurationProperties) throws IOException {
        ...
        this.useCountriesTxt = Boolean.valueOf(configurationProperties.getProperty(PROPERTY_USE_COUNTRIES_TXT) == null ? "true" :
                configurationProperties.getProperty(PROPERTY_USE_COUNTRIES_TXT));
        this.sendEmailAfterIngest = Boolean.valueOf(configurationProperties.getProperty(PROPERTY_SEND_EMAIL_AFTER_INGESTION) == null ? "true" :
                configurationProperties.getProperty(PROPERTY_SEND_EMAIL_AFTER_INGESTION));
        ...
        this.useMailSSLAuthentication = Boolean.valueOf(configurationProperties.getProperty(PROPERTY_USE_MAIL_AUTHENTICATION) == null ? "true" :
                configurationProperties.getProperty(PROPERTY_USE_MAIL_AUTHENTICATION));
        this.useOAINamespace = Boolean.valueOf(configurationProperties.getProperty(PROPERTY_USE_OAI_NAMESPACE) == null ? "false" :
                configurationProperties.getProperty(PROPERTY_USE_OAI_NAMESPACE));
    }
