...
/**
 * <p><code>Numeric</code> defines behaviour to validate a numeric value
 * (decimal integer).  </p>
 *
...
public class Numeric extends Datatype {
    ...
    /**
     * <p>Returns true if the given value is a numeric value.</p>
     *
     * @param value the <code>String</code> to validate
    ...
    /**
     * <p>Returns the integer value for a String value</p>
     *
