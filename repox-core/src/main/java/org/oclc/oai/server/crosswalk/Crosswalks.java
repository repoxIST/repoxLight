...
public class Crosswalks {
    ...
    /**
     * Find out which metadataFormats this repository supports and create the corresponding Crosswalk objects for each.
     *
        ...
        while (propNames.hasMoreElements()) {
            ...
            if (propertyName.startsWith(propertyPrefix)) {
                ...
                try {
                    ...
                    try {
                        Constructor crosswalkConstructor = crosswalkClass.getConstructor(new Class[]{String.class,
                                Properties.class});
                    ...
                    CrosswalkItem crosswalkItem = new CrosswalkItem(schemaLabel, crosswalk.getSchemaURL(), crosswalk
                            .getNamespaceURL(), crosswalk);
