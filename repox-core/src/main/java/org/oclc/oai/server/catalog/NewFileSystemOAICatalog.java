        ...
        try {
            ...
            for (String aList : list) {
                ...
                if (child.isDirectory() && !"CVS".equals(child.getName())) {
                    ...
                    fileDateMap.put(path,
                            XPathAPI.eval(datestampNode, "string()").str());
...
//                            + localIdentifier);
        ...
        for (Object o : fileDateMap.entrySet()) {
...
//             System.out.println("entry.getKey()=" + entry.getKey());
     ...
     * @throws OAIBadRequestException signals an http status code 400
     *                                problem
     * @throws OAINotFoundException   signals an http status code 404 problem
     */
