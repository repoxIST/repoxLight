...
/**
 * RecordFactory is responsible for pulling various pieces of information from native records such as the identifier,
 * datestamp, and sets. Note that the Crosswalk implementations are responsible for the creating the &lt;metadata&gt; part of
 * the response from native records.
 */
public abstract class RecordFactory {
     ...
     * @throws NoMetadatdaFormatsException This record doesn't support any of the available schemaLocations for this
     *                                     repository.
     */
    ...
    /**
     * Convert a native "item" to a "record" String. Use this version of createHeader if the setSpecs are derived from the
     * nativeItem itself.
     *
    ...
    /**
     * Convert a native "item" to a "record" String. Use this version of createHeader if the setSpecs are supplied from a
     * source other than the nativeItem itself.
     *
     * @param nativeItem the native record.
    ...
    /**
     * Create the &lt;record&gt; for the given record and metadataFormat selection. Use this version of create if the
     * setSpecs can be derived from the nativeItem itself.
     *
     * @param nativeItem the native record
     ...
     * @throws IllegalArgumentException One of the header components for this record is bad.
     * @throws This                     nativeItem doesn't support the specified metadataPrefix
     */
    public String create(Object nativeItem, String schemaURL, String metadataPrefix) throws IllegalArgumentException,
    ...
    /**
     * Create the &lt;record&gt; for the given record and metadataFormat selection. Use this version of create if the
     * setSpecs are derived from a source other other than the nativeItem itself.
     *
     * @param nativeItem the native record
     * @param schemaURL  the schemaURL desired for the response
     * @param the        metadataPrefix from the request
     ...
     * the entire &lt;record&gt; is already packaged as the native record.
     *
     * @param nativeItem the native record
     * @param schemaURL  the schemaURL desired for the response
     * @param the        metadataPrefix from the request
     ...
     * @param schemaURL  the schemaURL of the desired metadataFormat or NULL for a Record object containing all the supported
     *                   Crosswalk(s)
    ...
    public String create(Object nativeItem, String schemaURL, String metadataPrefix, String identifier, String datestamp,
                         Iterator setSpecs, Iterator abouts, boolean isDeleted) throws IllegalArgumentException,
            CannotDisseminateFormatException {
        if (debug)
    ...
    /**
     * Allows classes that implement RecordFactory to override the default createMetadata() method. This is useful, for
     * example, if the entire &lt;record&gt; is already packaged as the native record.
     *
     * @param nativeItem the native record
     * @param schemaURL  the schemaURL desired for the response
     * @param the        metadataPrefix from the request
     ...
     * @throws This                     nativeItem doesn't support the specified metadataPrefix
     */
    public String createMetadata(Object nativeItem, String schemaURL, boolean isDeleted) throws IllegalArgumentException,
            CannotDisseminateFormatException {
        StringBuffer xmlRec = new StringBuffer();
        if (isDeleted) {
            throw new CannotDisseminateFormatException("Record is deleted");
     ...
     * <p/>
     * Caveat: This brazenly assumes the record's local identifier exists somewhere within the native, or can be generated on
     * the fly.
     *
     * @param nativeItem the native record
    ...
    /**
     * Extract the local identifier from the native record. Since I forgot to add this originally, it is a roundabout way to
     * get this. It's a good idea to override this method to do it more directly.
     *
     * @param nativeItem the native record
     ...
     * <p/>
     * Caveat: This brazenly assumes the record's datestamp exists somewhere within the native record, or can be generated on
     * the fly.
     *
     * @param nativeItem the native record
     * @return String OAI identifier
    ...
    /**
     * Get an Iterator containing all the setSpecs for this native record. Return null if the setSpecs are derived from a
     * source other than the nativeItem itself. In this case, the AbstractCatalog is responsible for obtaining the setSpecs
     * which can be passed to the create() and createHeader() methods along with the nativeItem.
     *
     * @param nativeItem the native record
    ...
    /**
     * Get an Iterator containing all the &lt;about&gt; entries for this native record Return null if the abouts are derived
     * from a source outside the native record itself. In this case, the AbstractCatalog is responsible for obtaining the
     * abouts which can be passed to the create() method along with the nativeItem.
     *
     * @param nativeItem the native record
