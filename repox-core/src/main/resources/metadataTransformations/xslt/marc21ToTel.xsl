...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <xsl:template match="/">
        <record>
            <xsl:for-each
                    select="/rpx:record/rpx:datafield[@tag='710' or @tag='711' or @tag='720' or @tag='700' or    @tag='100' or @tag='110' or @tag='111']">
            ...
            <xsl:for-each
                    select="/rpx:record/rpx:datafield[@tag='800' or @tag='801' or @tag='810' or @tag='811' or @tag='820' or @tag='821']">
                <xsl:if test="rpx:subfield[@code='a'] or rpx:subfield[@code='b'] or rpx:subfield[@code='f']">
                    <dc:creator>
                        <xsl:if test="rpx:subfield[@code='a']">
                            <xsl:text xml:space="preserve"> </xsl:text>
            ...
            <xsl:for-each
                    select="/rpx:record/rpx:datafield[@tag='130' or @tag='210' or @tag='222' or @tag='240' or @tag='242' or @tag='246' or @tag='730' or @tag='740']/rpx:subfield[@code='a']">
                <dc:terms>
                    <xsl:value-of select="."/>
                </dc:terms>
            </xsl:for-each>
