...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                xmlns="http://krait.kb.nl/coop/tel/handbook/telterms.html" xmlns:rpx="info:lc/xmlns/marcxchange-v1"
    ...
    <xsl:template match="/">
        <record>
            ...
            <xsl:for-each
                    select="/rpx:record/rpx:datafield[@tag='700' or @tag='701' or @tag='710' or @tag='711' or @tag='720' or @tag='721']">
                <xsl:if test="rpx:subfield[@code='a'] or rpx:subfield[@code='b'] or rpx:subfield[@code='f']">
                    <dc:creator>
                        <xsl:if test="rpx:subfield[@code='a']">
                            <xsl:text xml:space="preserve"> </xsl:text>
            ...
            <xsl:for-each
                    select="/rpx:record/rpx:datafield[@tag='205' or @tag='207' or @tag='300' or @tag='303' or @tag='304'  or @tag='307' or @tag='305' or @tag='308' or @tag='317' or @tag='320' or @tag='326' or @tag='330' or @tag='327' or @tag='328']/rpx:subfield[@code='a']">
                <dc:description>
                    <xsl:value-of select="."/>
                </dc:description>
            </xsl:for-each>
            ...
            <xsl:if test="/rpx:record/rpx:datafield[@tag='071']/rpx:subfield[@code='a']">
                <dc:identifier>
                    <xsl:if test="/rpx:record/rpx:datafield[@tag='071']/rpx:subfield[@code='a']">Publishers' Numbers for
                        Music:
                    </xsl:if>
                    <xsl:if test="/rpx:record/rpx:datafield[@tag='071']/rpx:subfield[@code='a']">
                        <xsl:text xml:space="preserve"> </xsl:text>
            ...
            <xsl:for-each
                    select="/rpx:record/rpx:datafield[@tag='600' or @tag='601' or @tag='605' or @tag='606' or @tag='610' or @tag='686']">
                <xsl:if test="rpx:subfield[@code='a'] or rpx:subfield[@code='b'] or rpx:subfield[@code='c'] or rpx:subfield[@code='y'] or rpx:subfield[@code='z']">
                    <dc:subject>
                        <xsl:if test="rpx:subfield[@code='a']">
                            <xsl:text xml:space="preserve"> </xsl:text>
