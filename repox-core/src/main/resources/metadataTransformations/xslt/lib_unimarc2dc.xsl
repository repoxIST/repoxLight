...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <xsl:template name="unimarc2dc_qualified_identifier" xmlns:dcterms="http://purl.org/dc/terms/">
        ...
        <xsl:for-each select="//bn:controlfield[@tag='001']">
            <dc:identifier xsi:type='dcterms:URI'>
                <xsl:text>http://opac.porbase.org/ipac20/ipac.jsp?profile=porbase&amp;uri=full=3100024@!</xsl:text><xsl:value-of
                    select="."/><xsl:text>@!0&amp;ri=1&amp;aspect=basic_search&amp;menu=search&amp;source=192.168.0.17@!porbase&amp;ipp=20&amp;staffonly=&amp;term=&amp;index=&amp;uindex=&amp;aspect=basic_search&amp;menu=search&amp;ri=1</xsl:text>
            </dc:identifier>
        </xsl:for-each>
        <xsl:for-each select="//bn:controlfield[@tag='001']">
            <dc:identifier>
                <xsl:text>Id. do registo: </xsl:text><xsl:value-of select="."/>
            </dc:identifier>
        </xsl:for-each>
        ...
        <xsl:for-each select="//bn:datafield[@tag='011' ]/bn:subfield[@code='a']">
            <dc:identifier>
                <xsl:text>URN:ISSN:</xsl:text><xsl:value-of select="."/>
            </dc:identifier>
        </xsl:for-each>
        <xsl:for-each select="//bn:datafield[@tag='013' ]/bn:subfield[@code='a']">
            <dc:identifier>
                <xsl:text>URN:ISMN:</xsl:text><xsl:value-of select="."/>
            </dc:identifier>
        </xsl:for-each>
        <xsl:for-each select="//bn:datafield[@tag='020']/bn:subfield[@code='a']">
            <dc:identifier>
                <xsl:text>URN:NBN:</xsl:text><xsl:value-of select="."/>
            </dc:identifier>
        </xsl:for-each>
        <xsl:for-each select="//bn:datafield[@tag='071']/bn:subfield[@code='a']">
            <dc:identifier>
                <xsl:text>NÂº do Editor:</xsl:text><xsl:value-of select="."/>
            </dc:identifier>
        </xsl:for-each>
        ...
        <xsl:for-each select="//bn:datafield[@tag='966']">
            <dc:identifier>
                ...
                <xsl:value-of select=".//bn:subfield[@code='l']"/><xsl:text>-</xsl:text><xsl:value-of
                    select=".//bn:subfield[@code='s']"/>
            </dc:identifier>
        </xsl:for-each>
        <xsl:for-each select="//bn:datafield[@tag='021']">
            <dc:identifier>
                <xsl:text>URN:LDN:</xsl:text><xsl:value-of select=".//bn:subfield[@code='a']"/><xsl:text>:</xsl:text><xsl:value-of
                    select=".//bn:subfield[@code='b']"/>
            </dc:identifier>
        </xsl:for-each>
    ...
    <xsl:template name="unimarc2dc_qualified" xmlns:dcterms="http://purl.org/dc/terms/">
        ...
        <xsl:for-each
                select="//bn:datafield[@tag='500']/bn:subfield[@code='a'] | //bn:datafield[@tag='530']/bn:subfield[@code='a'] | //bn:datafield[@tag='518']/bn:subfield[@code='a'] | //bn:datafield[@tag='532']/bn:subfield[@code='a']">
            <dcterms:alternative>
                <xsl:value-of select="."/>
            </dcterms:alternative>
        </xsl:for-each>
        ...
        <!-- dc:Creator -->
        <xsl:for-each
                select="//bn:datafield[@tag='710' or @tag='711' or @tag='720' or @tag='721']"> <!-- @tag='700' or @tag='701' or     :: done in Java-->
            <dc:creator>
                <xsl:value-of select=".//bn:subfield[@code='a']"/>
        ...
        <!-- dc:Subject -->
        <xsl:for-each
                select="//bn:datafield[@tag='600' or @tag='601' or @tag='605' or @tag='606' or @tag='610' or @tag='686']">
            <dc:subject>
                <xsl:value-of select=".//bn:subfield[@code='a']"/>
                <xsl:if test=".//bn:subfield[@code='b']">
                    <xsl:text>, </xsl:text>
        ...
        <xsl:for-each
                select="//bn:datafield[@tag='205' or @tag='207' or @tag='300' or @tag='303' or @tag='304'  or @tag='307' or @tag='305' or @tag='308' or @tag='317' or @tag='320' or @tag='326' or @tag='330' or @tag='327' or @tag='328']/bn:subfield[@code='a']">
            <dc:description>
                <xsl:value-of select="."/>
            </dc:description>
        </xsl:for-each>
    ...
    <xsl:template name="unimarc2dc_simple">
        ...
        <xsl:for-each
                select="//bn:datafield[@tag='517']/bn:subfield[@code='a'] | //bn:datafield[@tag='500']/bn:subfield[@code='a'] | //bn:datafield[@tag='530']/bn:subfield[@code='a'] | //bn:datafield[@tag='518']/bn:subfield[@code='a'] | //bn:datafield[@tag='532']/bn:subfield[@code='a']">
            <dc:title>
                <xsl:value-of select="."/>
            </dc:title>
        </xsl:for-each>
        ...
        <!-- dc:Creator -->
        <xsl:for-each
                select="//bn:datafield[@tag='700' or @tag='701' or @tag='710' or @tag='711' or @tag='720' or @tag='721']">
            <dc:creator>
                <xsl:value-of select=".//bn:subfield[@code='a']"/>
                <xsl:if test=".//bn:subfield[@code='b']">
                    <xsl:text>, </xsl:text>
        ...
        <!-- dc:Subject -->
        <xsl:for-each
                select="//bn:datafield[@tag='600' or @tag='601' or @tag='605' or @tag='606' or @tag='610' or @tag='675' or @tag='686']">
            <dc:subject>
                <xsl:value-of select=".//bn:subfield[@code='a']"/>
                <xsl:if test=".//bn:subfield[@code='b']">
                    <xsl:text>, </xsl:text>
        ...
        <xsl:for-each
                select="//bn:datafield[@tag='205' or @tag='207' or @tag='300' or @tag='303' or @tag='304' or @tag='305' or @tag='308' or @tag='320' or @tag='326' or @tag='330' or @tag='327' or @tag='328']/bn:subfield[@code='a']">
            <dc:description>
                <xsl:value-of select="."/>
            </dc:description>
        </xsl:for-each>
    ...
    <xsl:template name="unimarc_aut2dc_simple">
        ...
        <xsl:if test="//bn:datafield[@tag='200' or @tag='210' or @tag='215' or @tag='220' or @tag='230' or @tag='235' or @tag='240' or @tag='245' or @tag='250']">
            <dc:title>
                <xsl:for-each
                        select="//bn:datafield[@tag='200' or @tag='210' or @tag='215' or @tag='220' or @tag='230' or @tag='235' or @tag='240' or @tag='245' or @tag='250']/bn:subfield[@code='a' or @code='b' or @code='f' or @code='k']">
                    <xsl:value-of select="."/>
                </xsl:for-each>
            </dc:title>
        </xsl:if>
        ...
        <!-- dc:Date -->
        <xsl:for-each
                select="//bn:datafield[@tag='200' or @tag='210' or @tag='215' or @tag='220' or @tag='230' or @tag='235' or @tag='240' or @tag='245' or @tag='250']/bn:subfield[@code='f' or @code='k']">
            <dc:date>
                <xsl:value-of select="."/>
            </dc:date>
        </xsl:for-each>
